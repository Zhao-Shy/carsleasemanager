...
CREATE TABLE `lease_contact`  (
  `id` int(11) NOT NULL COMMENT '租赁合同id',
  `deposit` decimal(11, 0) NOT NULL COMMENT '押金',
  `status` int(1) NOT NULL COMMENT '租赁方式（0出租，1预租，2续租）',
  `lease_type` int(1) NOT NULL COMMENT '租赁类型（0短租，1长租）',
  `begin_time` datetime(0) NOT NULL COMMENT '租赁开始时间',
  `end_time` datetime(0) NOT NULL COMMENT '租赁截止时间',
  `begin_oil` decimal(11, 0) NOT NULL COMMENT '租赁时油量',
  `end_oil` decimal(11, 0) NOT NULL COMMENT '归还时油量',
  ...
  `vehicle_id` int(11) NOT NULL COMMENT '租赁车辆id',
  `user_id` int(11) NOT NULL COMMENT '租赁用户id',
  ...
  CONSTRAINT `vehicle_id` FOREIGN KEY (`vehicle_id`) REFERENCES `sys_vehicle` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '租赁合同管理' ROW_FORMAT = Compact;
...
CREATE TABLE `sys_user`  (
  ...
  `user_type` int(1) NOT NULL COMMENT '用户类型（0普通用户，1会员）',
  ...
  `id_card_img` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '身份证照片',
  `driver_license_img` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '驾驶证照片',
...
CREATE TABLE `sys_vehicle`  (
  ...
  `contact_begin` datetime(0) NOT NULL COMMENT '车辆使用权开始时间',
  `contact_end` datetime(0) NOT NULL COMMENT '车辆使用权截止时间',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '创建者',
  `create_date` datetime(0) NOT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '更新者',
  `update_date` datetime(0) NOT NULL COMMENT '更新时间',
...
CREATE TABLE `vehicle_accident`  (
  `id` int(11) NOT NULL COMMENT '事故登记id',
  ...
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '0' COMMENT '删除标记',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `vehicle_id_accident`(`vehicle_id`) USING BTREE,
  CONSTRAINT `vehicle_id_accident` FOREIGN KEY (`vehicle_id`) REFERENCES `sys_vehicle` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '事故登记' ROW_FORMAT = Compact;
...
CREATE TABLE `vehicle_maintain`  (
  `id` int(11) NOT NULL COMMENT '维修记录id',
  ...
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '0' COMMENT '删除标记',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `vehicle_id_maintain`(`vehicle_id`) USING BTREE,
  CONSTRAINT `vehicle_id_maintain` FOREIGN KEY (`vehicle_id`) REFERENCES `sys_vehicle` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '维修记录' ROW_FORMAT = Compact;
